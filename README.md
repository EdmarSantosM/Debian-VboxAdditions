...
7.1 Para finalizar editei o arquivo txt criado na pasta compartilhada  (Windows) com as informações:
   ...
   - Exibindo  o conteudo do arquivo de texto (output)
    ...
    7.4   cat arquivo-de-teste.txt, onde consigo visualizar a informação
